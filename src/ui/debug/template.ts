...
const CHEVRON_ICON_SVG = `<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" style="display:block"><polyline points="9 18 15 12 9 6"/></svg>`;
...
export function ensureDebugShell(): DebugShell {
  ...
  if (!toggle) {
    ...
    toggle.innerHTML = CHEVRON_ICON_SVG;
